...
import { ProjectBlurb, ProjectPage } from './ProjectComponents.js';
...
class Home extends Component {
    ...
    handleNav(togglePage, newIndex) {
        this.setState({isProject: togglePage, projIndex: newIndex});
    }
    render() {
