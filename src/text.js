...
const home_text = <span>Welcome to my personal website, which I developed using {react_link}, with assets from {fa_link} and {bstrap_link}. Here you will find my various digital work, from graphic design to programming projects. The source code for this website is available on {repo_link}. More relevant links and my resumé can be found under ther 'More' tab.</span>;
