...
const projects = [
    {   "name":"AutoPlotter",
        ...
        "highlights":[
            {   "name":"Web Interface: Plot Page",
                "desc":"Most of the data analysis work I do is done on a remote server, making it a pain to sift through the many plots I often produce. To expedite this work, I wrote a simple web interface that displays plots in a more readable way.",
            ...
            {   "name":"Web Interface: Repository Page",
                "desc": "Because I make so many AutoPlotter page, it made sense to consolidate them under a single directory and beautify the navigation between them.",
    ...
    {   "name":"Photon Template Generator",
    ...
    render() {
        return (
          <Card>
            ...
            <CardFooter><Button outline onClick={evt => this.handleClick(evt, this.props.index)}>Learn More &raquo;</Button></CardFooter>
          </Card>
        );
    }
}
